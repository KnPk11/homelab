...
> [!NOTE]
> #OpenWebUI #Llm #AI #DockerCompose


## 1. Description

Open WebUI is a self-hosted chat front end for local or remote LLMs (e.g. Ollama), with conversations, models, and tools in a browser UI.
...
### Custom Image for Hardware Compatibility
