...
**Install on homelab-95** (repo is often only on ai-tools — use **copy**, not symlink, unless the repo is mounted on the node):

```bash
scp /opt/dev/homelab_repo/nodes/homelab-95/services/anytype/docker-compose.override.yml \
