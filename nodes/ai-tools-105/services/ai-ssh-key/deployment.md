# God Mode + Git SSH Keys — TTL Unlock (ai-tools-105)

> [!NOTE]
> **Tags:** #SSH #Security #AI #Homelab #GitHub  
> **Host:** ai-tools-105 | **Default TTL:** 2 hours
...
## 4. One-time install on ai-tools-105

```bash
REPO=/opt/dev/homelab_repo/nodes/ai-tools-105/services/ai-ssh-key
